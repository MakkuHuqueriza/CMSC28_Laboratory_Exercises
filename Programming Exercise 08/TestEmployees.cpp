...
int main() {
     ...
     // Prompt the user to enter employee details and read the inputs
     ...
     // Set the employee details using the setter methods
     ...
     // Display the personalized welcome message for the new employee
     cout << "\n=================================================================================================================" << endl;
